...
class App(tk.Tk):
    def __init__(self):
        ...
        tk.Button(row, text="Browse", command=self.pick_wav).pack(side="left", padx=(6,0))
        ...
        self.selected_preset.trace_add("write", lambda *args: self._update_preset_label())

        row3 = tk.Frame(self); row3.pack(**pad)
