...
static const ism_reg_t cc1101_cfg_rx[] = {
    ...
    {0x09, 0xEB}, // ADDR
    {0x0B,
     0x06}, // FSCTRL1:  IF = 152 kHz   <-- was missing, defaulted to 381 kHz
    ...
    {0x15, 0x31}, // DEVIATN:  14.3 kHz                    <-- was missing,
                  // defaulted to 47.6 kHz
    {0x17, 0x3F}, // MCSM1:    CCA, RX->RX, TX->RX (kept)
    {0x18, 0x18}, // MCSM0:    auto-cal IDLE->RX/TX
    {0x19, 0x16}, // FOCCFG:   freq offset comp ±BW/4      <-- was missing
    {0x1A, 0x6C}, // BSCFG:    bit sync defaults            <-- was missing
    {0x1B, 0x84}, // AGCCTRL2: MAGN_TARGET=24dB + VGA off (was 0x0C)
    {0x1C, 0x00}, // AGCCTRL1: disable LNA (was 0x00)
    {0x1D, 0x70}, // AGCCTRL0: keep fastest
    {0x1E, 0x10}, // WOREVT1   (kept)
    {0x1F, 0x80}, // WOREVT0   (kept)
    {0x20, 0x70}, // WORCTRL   (kept)
    {0x21, 0x56}, // FREND1:   RX front-end currents       <-- was missing
    {0x23, 0xE9}, // FSCAL3                                 <-- auto-cal will
                  // overwrite, OK to keep as seed
    {0x24, 0x2A}, // FSCAL2:   high VCO
    {0x25, 0x00}, // FSCAL1
    {0x26, 0x1F}, // FSCAL0
    {0x2C, 0x81}, // TEST2:    SmartRF analog preset       <-- was missing
...
static const ism_reg_t cc1101_cfg_tx[] = {
    ...
    {0x14, 0xF8}, // MDMCFG0
    {0x15, 0x31}, // DEVIATN
    {0x17, 0x00}, // MCSM1:    everything -> IDLE          <-- was 0x04 (RXOFF
                  // was FSTXON, not IDLE)
    {0x18, 0x18}, // MCSM0
    {0x19, 0x16}, // FOCCFG
    {0x1A, 0x6C}, // BSCFG
    ...
    {0x20, 0x70}, // WORCTRL
    {0x21, 0x56}, // FREND1
    {0x22, 0x10}, // FREND0:   PA_POWER=0 -> PATABLE[0]    <-- was missing
    {0x23, 0xE9}, // FSCAL3
    {0x24, 0x2A}, // FSCAL2
    {0x25, 0x00}, // FSCAL1
    {0x26, 0x1F}, // FSCAL0
